...
public class SpecificWhiteClicked extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_specific_white_clicked);
        ...
        */
		...
		Cursor c = MainActivity.wineDB.getWhiteWine();  //TO DO
		int size = c.getCount();
		Random r = new Random();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.specific_white_clicked, menu);
