...
public class SpecificRedClicked extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_specific_red_clicked);
        ...
        */
		...
		Cursor c = MainActivity.wineDB.getRedWine();  //TO DO
		int size = c.getCount();
		Random r = new Random();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.specific_red_clicked, menu);
