...
public class DescriptorSelected extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_descriptor_selected);
        ...
        */
		...
		Cursor c = MainActivity.wineDB.getWinesByDescriptor(descriptor);  //TO DO
		int size = c.getCount();
		Random r = new Random();
	...
	public void newDescriptorClicked(View view){
		TextView nameTextView = (TextView) findViewById(R.id.nameText);
		TextView varietalTextView = (TextView) findViewById(R.id.varietalText);
		TextView colorTextView = (TextView) findViewById(R.id.colorText);
		TextView dateTextView = (TextView) findViewById(R.id.dateText);
		
		Cursor c = MainActivity.wineDB.getWinesByDescriptor(descriptor);
		int size = c.getCount();
		Random r = new Random();
		int id = r.nextInt(size);
		c.moveToPosition(id);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.descriptor_selected, menu);
		return true;
	}
